# This Makefile is for the Net::NS::Update extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/NS/Update.pm]
#     AUTHOR => q[Olof Johansson <olof@cpan.org>]
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     MAN3PODS => { lib/Net/NS/Update.pm=>q[blib/man3/Net::NS::Update.3pm], lib/Net/NS/Update/nsupdate.pm=>q[blib/man3/Net::NS::Update::nsupdate.3pm] }
#     NAME => q[Net::NS::Update]
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Net/NS/Update.pm]
...
INSTALLPRIVLIB = /Library/Perl/Updates/5.12.5
DESTINSTALLPRIVLIB = $(DESTDIR)$(INSTALLPRIVLIB)
INSTALLSITELIB = /Library/Perl/5.12
DESTINSTALLSITELIB = $(DESTDIR)$(INSTALLSITELIB)
INSTALLVENDORLIB = /Network/Library/Perl/5.12
DESTINSTALLVENDORLIB = $(DESTDIR)$(INSTALLVENDORLIB)
INSTALLARCHLIB = /Library/Perl/Updates/5.12.5/darwin-thread-multi-2level
...
INST_LIBDIR      = $(INST_LIB)/Net/NS
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/NS
...
TO_INST_PM = lib/Net/NS/Update.pm \
	lib/Net/NS/Update/nsupdate.pm

PM_TO_BLIB = lib/Net/NS/Update.pm \
	blib/lib/Net/NS/Update.pm \
	lib/Net/NS/Update/nsupdate.pm \
	blib/lib/Net/NS/Update/nsupdate.pm
...
DISTNAME = Net-NS-Update
DISTVNAME = Net-NS-Update-0.1
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Net/NS/Update.pm blib/man3/Net::NS::Update.3pm \
	  lib/Net/NS/Update/nsupdate.pm blib/man3/Net::NS::Update::nsupdate.3pm 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Net-NS-Update' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.1' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Perl module to do dynamic updates for DNS zones' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Olof Johansson <olof@cpan.org>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl module to do dynamic updates for DNS zones</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Olof Johansson &lt;olof@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Net/NS/Update.pm blib/lib/Net/NS/Update.pm \
	  lib/Net/NS/Update/nsupdate.pm blib/lib/Net/NS/Update/nsupdate.pm 
